<template>
    <v-card-title class="tabs">
        <span style="font-size: 20pt">Nutrition This Week</span>
        <v-spacer></v-spacer>
    ...
    <v-row v-if="mealsData != null" style="height: calc(100% - 64px); width: 100%; margin-left: 0px; margin-top: 0px">
        ...
        <v-col style="padding: 10px; color: white; height: calc(100%); border-left: solid 1px white">
            <v-card
                ...
                <v-card class="summary-card">
                    <v-card-text style="text-align: left;">
                        <span style="font-size: 20pt"> Total Calories: {{ totalCalories.toFixed(2).toLocaleString()
                            }}</span>
                    </v-card-text>
                </v-card>
                <v-card class="summary-card">
                    <v-card-text style="text-align: left;">
                        <span style="font-size: 20pt"> Total Carbs: {{
                            totalCarbs.toFixed(2) }}g</span>
                    </v-card-text>
                </v-card>
                <v-card class="summary-card">
                    <v-card-text style="text-align: left;">
                        <span style="font-size: 20pt"> Total Fats: {{
                            totalFats.toFixed(2) }}g</span>
                    </v-card-text>
                </v-card>
                <v-card class="summary-card">
                    <v-card-text style="text-align: left;">
                        <span style="font-size: 20pt"> Total Protein: {{
                            totalProtein.toFixed(2) }}g</span>
                    </v-card-text>
                </v-card>
                <v-card class="summary-card">
                    <v-card-text style="text-align: left;">
                        <span style="font-size: 20pt"> Total Sugars: {{
    ...
    <div style="height: calc(100% - 64px); width: 100%; margin-left: 0px; margin-top: 0px; display: flex; justify-content: center; align-items: center;" v-else>
        <v-progress-circular indeterminate style="color: #003F7D;" size="20"></v-progress-circular>
    </div>
</template>
...
export default defineComponent({
    ...
    props: {
        mealsData: {
            type: Array as () => DailyIntake[] | null,
            required: true,
        },
    },
